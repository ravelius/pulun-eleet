...
function silma(s,prefix,taka){
  ...
  const sulku=rajaa(s.rapaytys),ilo=s.ilme,ylareuna=y-ry+7.5-ilo*2;
...
function paa(s,prefix){
  ...
  const aukko=`M55 116Q72 115 89 113Q96 ${n(118+3*a)} 84 ${n(123+13*a)}L58 ${n(123+17*a)}Z`;
  return `<g data-part="cartoon-head" data-face-shape="slender" transform="translate(${n(s.paaX)} ${n(s.paaY)}) rotate(${n(s.paaKulma)} 107 137)"><defs><mask id="${maski}" maskUnits="userSpaceOnUse" x="20" y="50" width="140" height="115" style="mask-type:luminance"><rect x="20" y="50" width="140" height="115" fill="white" stroke="none"/><path data-part="mouth-space" d="${aukko}" fill="black" stroke="none" opacity="${n(rajaa(a*4))}"/></mask></defs><g mask="url(#${maski})"><path data-part="face-outline" d="M72 88C78 76 90 72 105 74C122 72 133 85 132 101C132 116 124 127 118 133L120 136L115 136Q105 143 92 138Q80 134 80 126Q67 121 67 109Q66 97 72 88Z" fill="#9bafbd"/><path d="M111 77Q130 84 130 101Q129 119 119 131L121 134L116 135Q108 140 98 138Q116 124 117 103Q119 86 111 77Z" fill="#7f99a9" stroke="none"/><path d="M74 89Q82 78 99 77Q84 82 77 95" fill="none" stroke="#c3d0d5" stroke-width="3.5"/><path d="M94 75Q98 67 108 68Q107 72 103 74Q112 69 119 73L112 77" fill="#9bafbd"/><path data-part="soft-cheek" d="M93 115Q100 112 105 116L104 125Q98 128 90 124Z" fill="#c2cfd2" stroke="none" opacity=".24"/><ellipse data-part="cheek-warmth" cx="101" cy="122" rx="4.8" ry="2.5" fill="#d59fa7" stroke="none" opacity="${n(.14+s.ilme*.1)}"/></g>${silma(s,prefix,true)}${silma(s,prefix,false)}<g data-part="cartoon-beak" data-opening="${n(a)}" data-beak-shape="pigeon" stroke-width="1.7"><path data-part="mouth-inside" d="M85 115Q92 111 95 116Q96 ${n(124+7*a)} 85 ${n(123+13*a)}L81 ${n(125+11*a)}Q92 ${n(122+3*a)} 85 115Z" fill="#936f79" stroke-width="1.6"/><path data-part="tongue" d="M67 ${n(120+11*a)}Q70 ${n(115+10*a)} 76 ${n(118+11*a)}Q81 ${n(114+12*a)} 85 ${n(120+11*a)}Q82 ${n(126+11*a)} 76 ${n(125+11*a)}Q70 ${n(125+11*a)} 67 ${n(120+11*a)}Z" fill="#e7a0a8" stroke="#af7280" stroke-width="1.2" opacity="${n(rajaa(a*2))}"/><path d="M73 ${n(119+11*a)}Q76 ${n(122+11*a)} 80 ${n(119+11*a)}" fill="none" stroke="#b87785" stroke-width="1" opacity="${n(a)}"/><path data-part="lower-beak" d="M62 ${n(121+13*a)}Q74 ${n(125+15*a)} 86 ${n(121+14*a)}Q92 ${n(119+8*a)} 93 115Q96 ${n(123+8*a)} 87 ${n(125+14*a)}Q74 ${n(129+15*a)} 62 ${n(124+13*a)}Q59 ${n(122+13*a)} 62 ${n(121+13*a)}Z" fill="#7994a4"/><g transform="rotate(${n(a*7)} 86 113)"><path d="M77 110Q83 106 88 110L92 114Q79 117 58 120Q64 114 70 112Z" fill="#728b9d"/><path d="M64 117Q73 113 80 113" fill="none" stroke="#bdd0d5" stroke-width="2.5"/><path data-part="cere" d="M73 110Q74 105 79 106Q81 103 85 106Q89 106 88 111Q82 110 79 113Z" fill="#ede7d1" stroke-width="1.6"/></g><path d="M91 117Q96 120 99 115" fill="none" stroke-width="2"/><path d="M95 114Q99 112 102 115" fill="none" stroke-width="1.4" opacity="${n(a)}"/></g></g>`;
}
...
export function sarjakuvapulunKuva(s,{prefix,right}){
  ...
  const jousto=s.id==='uusi-livia-ilahtuu'?`<g data-part="breath" transform="translate(110 174) scale(${n(1-.035*s.hengitys)} ${n(1+.05*s.hengitys)}) translate(-110 -174)">`:"";
